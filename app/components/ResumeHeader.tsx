...
export default function ResumeHeader() {
  ...
  return (
    <header className="bg-black text-white py-12 px-8 border-b-4 border-black">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
          ...
          >
            <div className="relative w-32 h-32 md:w-40 md:h-40 border-4 border-white overflow-hidden bg-gray-800">
          ...
          <div className="flex-1 text-center md:text-left">
            <h1 className="text-4xl md:text-5xl font-bold mb-2 gradient-text-white">
              VINCE MARC JUSTINE O. RUBANG
            </h1>
            <p className="text-xl md:text-2xl text-gray-300 mb-4">Full-Stack Developer</p>
